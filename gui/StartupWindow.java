...
public class StartupWindow extends JFrame implements ServerFinder.ServerListener{
//OVERVIEW: StartupWindow is a public and mutable class
//it extends JFrame class and implements ServerFinder.ServerListener interface 
	
	//Data Type     
	//All the rep var  cannot be null
    ...
    //   	   else if create a new StartupWindow object by calling the initComponents() and initOthers functions
        initComponents();
        initOthers();
    }
    ...
    //EFFECTS: initialize the GUI components for the class,this function should be called by the constructor only
    ...
    //         initialize the data for ServerList;
        ...
        JoinYourDefinedServerButton.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(DefineLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 196, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(NickNameLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(QuitButton, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                                    .addComponent(joinServerButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                                    .addComponent(ServerButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)
                                    .addComponent(NickNameTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE)))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(passwordLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 69, Short.MAX_VALUE)
                                    .addComponent(PortLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 69, Short.MAX_VALUE)
                                    .addComponent(HostNameLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 69, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(HostNameTextF, javax.swing.GroupLayout.DEFAULT_SIZE, 123, Short.MAX_VALUE)))
                            .addComponent(JoinYourDefinedServerButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 196, Short.MAX_VALUE))))
                .addContainerGap())
        );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(NickNameTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
                            .addComponent(NickNameLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(ServerButton, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(joinServerButton, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(QuitButton, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(DefineLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(JoinYourDefinedServerButton, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE))
    ...
    //		   else if create a new CreateServerWindow with text from NickNameTextField and set it visible
    ...
    //         else if IndexOutOfBoundsException occurs then create a Dialog with a error message
    //		   else if get the data from the selected ServerVariable object and check if password is required
    //         if a password is required then create a ClientPasswordInputWindow and set it visible
    //         if a password is not required then create a Client thread with required input agurments and start it
    		try{
    ...
    private void JoinYourDefinedServerButtonMouseReleased(java.awt.event.MouseEvent evt) throws NumberFormatException, IOException {                                         
        //EFFECTS: if cannot parse HostNameTextF.getText() to Integer then throw NumberFormatException
    	//		   else if evt is null then throws NullPointerException
    	//		   else if IO problems occur then throws IOException
    	//		   else create a Client thread with required input arguments and start it
    	
    	Client c = new Client(this.HostNameTextF.getText(),Integer.parseInt(this.HostNameTextF.getText()), NickNameTextField.getText(), passwordTF.getText());
        c.start(); 
    }                                        
    ...
    //		   else if start up the application by create a StartupWindow Object and set it visible
	...
	//		   if there is a same ServerVariable in the svList already then updates the # of members
	//         if no same server exists then add the new ServerVariable in the svList
	//         Finally, reset the ServerList data with svList and reset the user selected index
