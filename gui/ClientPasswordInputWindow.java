...
public class ClientPasswordInputWindow extends JFrame {
	//OVERVIEW: ClientPasswordInputWIndow is a subclass of JFrame, it is public, it is created 
    ...
    public ClientPasswordInputWindow(ServerVariable b, String userName) {
    	//EFFECTS:create a ClientPasswordInputWindow with a server reference and a user name
    ...
    private void passwordInputFieldKeyPressed(java.awt.event.KeyEvent evt) {                                              
    	...
    	//		   else if "Enter" key is pressed then set password equals to passwordInputField.getPassword();
