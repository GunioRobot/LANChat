...
//OVERVIEW: ServerWindow is a public class and a subclass of JFrame
    ...
    //EFFECTS: create a new ServerWindow object with a Client thread and call the initComponents()
    ...
    //EFFECTS:if evt is NULL then throw NullPointerException
    //        else if both Control key and Enter key is downed then add a new line for TextInputPanel
    //        else if only Enter key is downed then set text to the text from the TextInputPanel
