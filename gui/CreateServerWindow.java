...
//OVERVIEW: CreateServerWindow is a public class that extends JFrame
    ...
    private void passwordCheckboxMouseReleased(java.awt.event.MouseEvent evt) {                                               
    	...
    	//         else if the state of passwordCheckbox is true then set passwordField to be non-editable
    	//		   else if the state of passwordCheckbox is false then set passwordField to be editable
    ...
    private void createrServerButtonMouseReleased(java.awt.event.MouseEvent evt) throws IOException {
        ...
        Server s = new Server(serverNameField.getText(), passwordField.getText(), passwordCheckbox.getState(), userName);
        s.start();
        dispose();
    }                                                 
